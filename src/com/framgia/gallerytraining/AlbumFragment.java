...
//  		abGridView.setAdapter(picAdapter);
    ...
    private class ImageAdapter extends BaseAdapter {
        ...
        public int getCount() {
            ...
            return listPictures.getListPictures().size() + mNumColumns;
        }

        @Override
        public Object getItem(int position) {
            return position < mNumColumns ?
                    null : listPictures.getListPictures().get(position - mNumColumns);
        }
        ...
        public View getView(int position, View convertView, ViewGroup container) {
            ...
            mImageFetcher.loadImage(listPictures.getListPictures().get(position - mNumColumns).getDataPicture(), imageView);
            return imageView;
